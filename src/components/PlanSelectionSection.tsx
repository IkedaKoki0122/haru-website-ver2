              ...
              >
                {plans.map((plan) => (
                  <div key={plan.id} className="w-full flex-shrink-0 px-4">
                    <motion.div 
                      className={`relative border-2 rounded-xl overflow-hidden transition-all duration-300 border-gray-200 hover:border-orange-300 ${plan.popular ? 'ring-2 ring-orange-400' : ''}`}
