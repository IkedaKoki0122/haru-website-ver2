  ...
  const courses = useMemo(() => [
    {
      ...
      price: '¥49,800',
      duration: '3ヶ月',
      description: '英語学習を始めたばかりの方に最適な入門プランです。基礎からしっかりサポートします。',
      features: [
        '月2回のオンライン個別指導',
        '基礎文法・語彙学習サポート',
        '学習計画の作成',
    ...
    },
    {
      ...
      price: '¥79,800',
      duration: '6ヶ月',
      description: '着実にレベルアップを目指す方向けの標準プランです。バランスの良い学習を提供します。',
      features: [
        '学校選び・出願サポート',
        'アパート紹介・契約代行',
        '空港送迎サービス',
        ...
        {selectedCourse && (
          ...
          >
            <p className="text-gray-600 mb-6 text-lg">
              {courses.find(p => p.id === selectedCourse)?.name}が選択されています。
              <br />
