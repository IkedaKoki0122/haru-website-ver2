  ...
  const testimonials = useMemo(() => [
    {
      ...
      comment: "英語習得研究所受講前は英語に自信がありませんでしたが、3ヶ月で劇的に変わりました。専属コンサルタントの方が毎日の学習をサポートしてくれたおかげで、継続することができました。特にビジネス英会話の実践練習が効果的で、今では海外の取引先との会議でも積極的に発言できるようになりました。"
    },
    {
      name: "佐藤 花子",
      job: "30代・IT企業",
    ...
    },
    {
      ...
      comment: "短期集中だからこそ結果が出せました。おすすめです。40代での転職を考えていた時に、英語力が必要だと感じて英語習得研究所を受講しました。科学的なアプローチで効率的に学習でき、短期間で確実にスキルアップできました。今では外資系企業で働いています。"
    },
    {
      name: "鈴木 美咲",
      job: "30代・医療関係",
      ...
      comment: "仕事で英語が必要になり受講。今では会議で発言できるようになりました。医療現場での国際的なプロジェクトに参加することになり、急遽英語力を向上させる必要がありました。英語習得研究所の集中的なプログラムのおかげで、専門用語も含めて英語でのコミュニケーションができるようになりました。"
    },
    {
      name: "高橋 健一",
      job: "20代・教育関係",
      ...
      comment: "毎日のコーチングサポートで学習習慣が身につきました。教師として生徒に英語を教える立場でありながら、自分の英語力に不安がありました。英語習得研究所で基礎から体系的に学び直すことで、自信を持って授業ができるようになりました。生徒からの評価も向上しています。"
    },
    {
      name: "伊藤 雅子",
      job: "40代・製造業",
      ...
      comment: "海外出張での交渉が自信を持ってできるようになりました。製造業で海外工場との連携が重要な役割を担っていましたが、英語でのコミュニケーションが課題でした。英語習得研究所で実践的なビジネス英語を学び、今では現地スタッフとも円滑にやり取りができています。"
    }
  ], []);
      ...
      <main>
        ...
        <section className="bg-gradient-to-r from-orange-500 to-orange-600 py-16 overflow-hidden">
          <div className="max-w-6xl mx-auto px-6 text-center">
            ...
            >
              英語習得研究所で英語力を向上させた受講生の生の声をお聞きください。
