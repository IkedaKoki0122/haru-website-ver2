  ...
  const testimonials = useMemo(
    () => [
      ...
      },
      {
        ...
        comment:
          "仕事で英語を使う機会が増え、より実践的な英語力を身につけたくてLumos Language Schoolに通いました。Utah Study Supportのおかげで、質の高いカリキュラムと優秀な講師陣に出会うことができました。少人数制のクラスで個人の弱点に合わせた指導を受けられ、スピーキング力が格段に向上しました。現地でのインターンシップの機会も紹介していただき、実際のビジネスシーンで英語を使う経験も積むことができました。",
      },
    ],
    []
  );
