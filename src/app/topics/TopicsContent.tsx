    ...
    () => [
      {
        ...
        excerpt:
          "ユタ州の主要大学への2025年度入学申請サポートを開始しました。経験豊富なスタッフが合格まで完全サポートいたします。",
        category: "留学準備",
        image: "/news-01.jpg",
      },
      {
        ...
        excerpt:
          "ユタ州プロボ市に新しい学生向けアパートがオープン。キャンパスから徒歩圏内の好立地で、留学生に人気の設備が充実しています。",
        category: "住居情報",
        image: "/news-02.jpg",
      },
      {
        ...
        excerpt:
          "Utah Study Support経由での2024年度ユタ大学合格率が95%を達成しました。徹底したサポート体制の成果です。",
        category: "学校情報",
        image: "/news-03.jpg",
      },
      {
        ...
        excerpt:
          "2024年度のアメリカ学生ビザ申請手続きに関する最新情報をお届け。申請から取得までの流れを詳しく解説します。",
        category: "ビザ・手続き",
        image: "/news-04.jpg",
      },
      {
        ...
        excerpt:
          "Utah Study Supportを利用してユタ大学に留学中の学生による体験談。現地での学習環境や生活の様子をお届けします。",
        category: "体験談",
        image: "/news-05.jpg",
      },
      {
        ...
        excerpt:
          "初めてユタ州で冬を過ごす留学生向けに、気候の特徴と適切な服装選びのポイントをご紹介します。",
        category: "現地生活",
        image: "/news-06.jpg",
      },
      {
        ...
        excerpt:
          "ユタ州には複数の州立大学があります。それぞれの特色や専攻分野を比較し、あなたに最適な大学選びをサポートします。",
        category: "学校情報",
        image: "/news-07.jpg",
      },
      {
        ...
        excerpt:
          "ユタ州留学を控えている方向けに、現地で困らないために日本から持参すべき必需品をリストアップしました。",
        category: "留学準備",
        image: "/news-08.jpg",
      },
    ],
