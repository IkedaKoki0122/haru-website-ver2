    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-4xl mx-auto px-6 py-16">
        ...
        <div className="prose prose-lg max-w-none text-gray-700">
          ...
          <h2 className="text-xl font-bold text-gray-900 mb-4 mt-8">第3条（利用料金）</h2>
          <p className="mb-6 leading-relaxed">
            利用者は、本サービスの対価として、当社が別途定める利用料金を、当社が指定する方法により支払うものとします。利用料金は、当社のウェブサイトまたはその他の方法で告知いたします。
          </p>

          <h2 className="text-xl font-bold text-gray-900 mb-4 mt-8">第4条（禁止事項）</h2>
          <p className="mb-4 leading-relaxed">利用者は、本サービスの利用にあたり、以下の行為をしてはなりません。</p>
          ...
          <h2 className="text-xl font-bold text-gray-900 mb-4 mt-8">第5条（本サービスの提供の停止等）</h2>
          <p className="mb-6 leading-relaxed">
          ...
          <h2 className="text-xl font-bold text-gray-900 mb-4 mt-8">第6条（利用制限および登録抹消）</h2>
          <p className="mb-6 leading-relaxed">
          ...
          <ul className="list-disc pl-6 mb-6 space-y-2">
            ...
            <li>本サービスについて、最後の利用日から一定期間利用がない場合</li>
            <li>その他、当社が本サービスの利用を適当でないと判断した場合</li>
          </ul>

          <h2 className="text-xl font-bold text-gray-900 mb-4 mt-8">第7条（保証の否認および免責事項）</h2>
          <p className="mb-6 leading-relaxed">
            当社は、本サービスに事実上または法律上の瑕疵（安全性、信頼性、正確性、完全性、有効性、特定の目的への適合性、セキュリティなどに関する欠陥、エラーやバグ、権利侵害などを含みます。）がないことを明示的にも黙示的にも保証しておりません。
          </p>

          <h2 className="text-xl font-bold text-gray-900 mb-4 mt-8">第8条（サービス内容の変更等）</h2>
          <p className="mb-6 leading-relaxed">
            当社は、利用者に通知することなく、本サービスの内容を変更しまたは本サービスの提供を中止することができるものとし、これによって利用者に生じた損害について一切の責任を負いません。
          </p>

          <h2 className="text-xl font-bold text-gray-900 mb-4 mt-8">第9条（利用規約の変更）</h2>
          <p className="mb-6 leading-relaxed">
            当社は、必要と判断した場合には、利用者に通知することなくいつでも本規約を変更することができるものとします。なお、本規約の変更後、本サービスの利用を開始した場合には、当該利用者は変更後の規約に同意したものとみなします。
          </p>

          <h2 className="text-xl font-bold text-gray-900 mb-4 mt-8">第10条（個人情報の取扱い）</h2>
          <p className="mb-6 leading-relaxed">
            当社は、本サービスの利用によって取得する個人情報については、当社「プライバシーポリシー」に従い適切に取り扱うものとします。
          </p>

          <h2 className="text-xl font-bold text-gray-900 mb-4 mt-8">第11条（通知または連絡）</h2>
          <p className="mb-6 leading-relaxed">
          ...
          <h2 className="text-xl font-bold text-gray-900 mb-4 mt-8">第12条（権利義務の譲渡の禁止）</h2>
          <p className="mb-6 leading-relaxed">
            利用者は、当社の書面による事前の承諾なく、利用契約上の地位または本規約に基づく権利もしくは義務を第三者に譲渡し、または担保に供することはできません。
          </p>

          <h2 className="text-xl font-bold text-gray-900 mb-4 mt-8">第13条（準拠法・裁判管轄）</h2>
          <p className="mb-6 leading-relaxed">
