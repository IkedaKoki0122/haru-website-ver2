...
export const metadata: Metadata = {
  ...
  description: 'ユタ州での留学・語学学校選びをサポート。業界最安値¥79,800でプロフェッショナルな留学支援を提供。学校選びから住居手配、現地サポートまでワンストップでトータルサポートします。',
  keywords: ['アメリカ留学', 'ユタ州', '語学学校', '留学サポート', '英語学習', '海外留学', 'プロボ', '留学斡旋'],
  openGraph: {
    title: 'Utah Study Support | ユタ州留学・語学学校サポート',
    description: 'ユタ州での留学・語学学校選びをサポート。業界最安値¥79,800でプロフェッショナルな留学支援を提供。',
    type: 'website',
